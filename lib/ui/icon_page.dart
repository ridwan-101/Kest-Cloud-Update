...
import 'package:kingslist/ui/home_page.dart';
...
class _IconPageState extends State<IconPage> {
  ...
  late Map<String?, IconData> iconsMap;
  late Map<String?, IconData> allIconsMap;
  late double? height, elevation = 0;

  @override
  void initState() {
    super.initState();

    // allIconsMap = Map.fromEntries(FontAwesomeIconsMap.key
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: <Widget>[
              Transform.scale(scale: 2, child: Icon(Icons.face_outlined)),
