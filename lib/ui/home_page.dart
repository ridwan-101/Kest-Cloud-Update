          ...
          drawer: Drawer(
            ...
            child: SingleChildScrollView(
              ...
              builder: (_, AsyncSnapshot<List<Project>> snapshot) {
                ...
                var p = snapshot.data!.map((e) => pp = e);
                return Flex(
                    ...
                    if (snapshot.hasData)
                      Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                              "${pp.tasks.where((t) => t.isDone).toList().length}/${pp.tasks.length}"),
                          onTap: () {
                            projectBloc.getProjectById(pp.uid!);
                            Navigator.pop(context);
                          },
                          onLongPress: () => onProjectListTileLongPressed(pp),
                        ),
                      ),
      ...
      return Dismissible(
        ...
        secondaryBackground: Padding(
          ...
          child: Container(
            ...
            color: Color.fromARGB(255, 199, 138, 133),
            child: Icon(
              Icons.delete,
              color: Colors.white,
            ),
