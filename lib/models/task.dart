...
class Task extends Comparable {
  ...
  Task.fromMap(Map map)
      : this.createdDate = map[createdDateKey] == "null"
            ? null
            : DateTime.parse(map[createdDateKey]) {
    this.id = map[idKey];
    this.uid = map[uidKey];
    this.title = map[titleKey];
    this.description = map[descriptionKey];
    this.finishedDate = map[finishedDateKey] == "null"
        ? null
        : DateTime.parse(map[finishedDateKey]);
    this.dueDate =
        map[dueDateKey] == "null" ? null : DateTime.parse(map[dueDateKey]);
  ...
  Map toMap() => {
        ...
        statusKey: this.status.toString(),
      };
